...
/**
 * Here we define the and controller
 *
 * Consider expr1 and expr2; : if expr1 is false, we can just jump away.
 */
...
/**
 * Same story for the or operator
 *
 * If atleast one expression is true, we can just emit true and jump away
 */
